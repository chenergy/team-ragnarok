...
namespace FightGame
{
	public class Buff_Claw : A_Buff
	{
		GameObject fire;

		public Buff_Claw ( float duration, A_Fighter attackOwner, string name, float chargeTime = 0.7f ) : base( duration, attackOwner, name, chargeTime )
		{
			this.name = "Claw";
		}
